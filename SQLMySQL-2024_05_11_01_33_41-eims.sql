...
INSERT INTO `client` VALUES ('刘七','567890','成都市武侯区','liuqi@example.com'),('吴十一','901234','杭州市西湖区','wushiyi@example.com'),('周十','890123','南京市鼓楼区','zhoushi@example.com'),('孙九','789012','武汉市江岸区','sunjiu@example.com'),('张三','123456','北京市朝阳区','zhangsan@example.com'),('李四','234567','上海市浦东新区','lisi@example.com'),('王五','345678','广州市天河区','wangwu@example.com'),('赵六','456789','深圳市福田区','zhaoliu@example.com'),('郑十二','012345','苏州市姑苏区','zhengshier@example.com'),('钱八','678901','重庆市渝中区','qianba@example.com');
...
CREATE TABLE `contact` (
  ...
  `contactStart` date DEFAULT NULL,
...
CREATE TABLE `cs` (
  `clientName` varchar(10) NOT NULL,
  `staffName` varchar(30) NOT NULL,
  `clineOpinion` varchar(255) DEFAULT NULL,
...
INSERT INTO `cs` VALUES ('刘七','周十','需要调整产品配置'),('吴十一','张三','希望产品能够增加新功能'),('周十','郑十二','对推广策略提出建议'),('孙九','吴十一','希望加快问题处理速度'),('张三','李四','对产品性能有疑问，请解答'),('李四','王五','希望能够提供更多定制化方案'),('王五','刘七','对技术支持及时性有意见'),('赵六','钱八','对账单有疑问，请核实'),('郑十二','李四','需要了解最新的产品更新'),('钱八','孙九','感谢客服的耐心解答');
...
-- Dump completed on 2024-05-11  1:33:41
